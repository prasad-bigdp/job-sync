...
import {
  ...
  Paper, useMediaQuery, InputAdornment, IconButton, CircularProgress
} from '@mui/material';
import {
  Visibility, VisibilityOff, PersonOutline, EmailOutlined,
  LockOutlined, ArrowForward, PhoneAndroidOutlined
              ...
              <Paper elevation={5} sx={{ maxWidth: 900, width: '100%', display: 'flex', flexDirection: { xs: 'column', md: 'row' }, overflow: 'hidden' }}>
                ...
                {!isSmallScreen && (
                  <Box sx={{ width: '60%', p: 4, bgcolor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <img
                      src="https://res.cloudinary.com/dkg3qriqq/image/upload/v1747373698/4236127_ntd8xk.jpg"
                      alt="Signup"
