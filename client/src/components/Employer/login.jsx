...
function EmployeeLogin() {
  ...
  const onSubmit = async (values, { setSubmitting }) => {
    try {
        ...
        console.log("employerdata",res.data.employer)
            ...
            {({ isSubmitting }) => (
              <Form>
                ...
                <div className="text-center mb-4">
                  ...
                  <Link to="/EmployerSignup" className="inline-block align-baseline font-semibold text-sm text-blue-500 hover:text-blue-800">
                    Sign up
                  </Link>
                </div>
