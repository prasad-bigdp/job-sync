             ...
             >
               ...
               >
                 ...
                 <div className=" flex items-center gap-3 max-lg:text-[0.7rem] text-[14px]  max-[768px]:hidden">
                    <div className="font-[500]">Jobs</div>
                    <div className="font-[500]  ">Services</div>
                    <div  className="font-[500] ">Highlight</div>
                    <div className="font-[500] ">Prep</div>
                    <div className="font-[500]">Learn</div>
                    <div className="font-[500] ">Career Advice</div>
                 </div>
                   ...
                   <div className='flex items-center gap-4'>
                      ...
                      <div className=' max-[768px]:hidden'>
                          <button onClick={()=>setToggle(!toggle)} style={{backgroundColor:"#F1E6F9"}} className='flex gap-3  relative cursor-pointer border border-stone-300 h-[40px] p-2 rounded-[25px] items-center'>
                             ...
                             <span className='text-[12px]'>Hi,sameer</span>
                              <AlignLeft size={19}/>
