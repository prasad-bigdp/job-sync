...
//   try {
//     const { title, description, company,skillsRequired,location,salaryRange} = req.body;
//     const employerId = req.user.id; //from middleare we collect these

//     const newJob = new Job({
//       title, description, company,skillsRequired,location,salaryRange,employer: employerId
//     });
    

//     const savedJob = await newJob.save();

//     await Employer.findByIdAndUpdate(employerId, {//find by id and employer can see his posted jobs
//       $push: { createdJobs: savedJob._id }
//     });

//     res.status(201).json({ message: 'Job was posted successfully', job: savedJob });
//   } catch (err) {
